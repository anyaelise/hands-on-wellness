...
<div id="booking">	
	...
	echo form_radio($data)."In-call @ ".anchor("http://www.educatinghands.com/", "Educating Hands Professional Clinic").", 3883 Biscayne Blvd, Miami FL 33137<br>";
	$data = array(
		'name'        => 'location',
    	'value'       => '1',
	...
	echo form_dropdown('service', $service_array, 0)."<br><br></div>";
	...
	echo form_radio($data)."Credit/Debit card</div>";
